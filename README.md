...
Mouse
Click the terminal icon (>) in the taskbar to open a terminal window. Click the red dot to close it. Click and drag the title bar to move the window anywhere on screen.
...
Build output	build/myos.img — raw 1.44MB floppy image
